...
import com.example.NourishConnect.databinding.ActivityFoodMapBinding;
...
public class FoodMap extends FragmentActivity implements OnMapReadyCallback {
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        // Animate camera to Kenya
        LatLng kenLatLng = new LatLng(0.0236, 37.9062);
        float zoomLevel = 5.0f; // You can adjust the zoom level as per your preference
        mMap.animateCamera(CameraUpdateFactory.newLatLngZoom(kenLatLng, zoomLevel));
    }
